...
public abstract class AbstractFileReader {
    ...
    public String findSmallestDifferenceName() {
        ...
        List<DataWithDifference> data = extractData(lines, getNamePosition(), getNameValue1(), getNameValue2());
    ...
    public abstract Position getNameValue1();

    public abstract Position getNameValue2();
